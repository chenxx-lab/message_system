...
<?php
    ...
    if(isset($_SESSION['username']) && $_SESSION['username']==='小宁'){
        ...
        echo "<a href='user_logout.php'>注销</a>";
    }  else {
        echo "<a href='user.php'>请登入</a>";
    }
?>
</head>
<body>
    ...
    <div class="container" style="padding-top: 5px;">
    	<div class="row">
    		...
    		<div class="col-sm-1">
    			<a href="user_logout.php" class="text-center">退出系统</a>
    		</div>
    	</div>
    </div>
...
<div class="right">
	<iframe name="show_right" id="show_right" src="right.html" frameborder="0" width="100%" height="500" scrolling="yes"></iframe>
